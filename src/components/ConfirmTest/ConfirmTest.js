...
export default function ConfirmTest({ createResult, handleBackToTest }) {
  return (
    <section className="confirm-section">
      <h3>Anda yakin ingin menyelesaikan tes ini ?</h3>
      <Link className="btn btn-outline-primary fs-5 m-3" onClick={createResult} to="/result">Ya</Link>
